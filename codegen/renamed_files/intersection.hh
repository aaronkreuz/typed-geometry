...
template <class A, class B>
[[nodiscard]] constexpr auto intersectionTODO_MANUALLY(A const& a, B const& b) -> decltype(a[intersection_parameter(a, b)])
{
...
template <class A, class B>
[[nodiscard]] constexpr auto intersectionTODO_MANUALLY(A const& a, B const& b) -> cc::optional<decltype(a[intersection_parameter(a, b).value()])>
{
...
template <class A, class B>
[[nodiscard]] constexpr auto intersectionTODO_MANUALLY(A const& a, B const& b) -> typename decltype(intersection_parameter(a, b))::template as_hits<typename A::pos_t>
{
...
[[nodiscard]] constexpr auto intersectionTODO_MANUALLY(A const& a, B const& b)
...
template <int D, class ScalarT, class Obj>
[[nodiscard]] constexpr auto intersection_parameterTODO_MANUALLY(line<D, ScalarT> const& l, Obj const& obj)
...
template <int D, class ScalarT, class Obj>
[[nodiscard]] constexpr auto intersection_parameterTODO_MANUALLY(ray<D, ScalarT> const& ray, Obj const& obj)
...
// line - point
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line1(line<1, ScalarT> const& l, pos<1, ScalarT> const& p)
{
...
// line - line
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line2(line<2, ScalarT> const& l0, line<2, ScalarT> const& l1)
{
...
// line - ray
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line2(line<2, ScalarT> const& l, ray<2, ScalarT> const& r)
{
...
// line - segment
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line2(line<2, ScalarT> const& l, segment<2, ScalarT> const& s)
{
...
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, plane<D, ScalarT> const& p)
{
...
// line - halfspace
template <int D, class ScalarT>
[[nodiscard]] constexpr cc::optional<hit_interval<ScalarT>> intersection_parameter_line(line<D, ScalarT> const& l, halfspace<D, ScalarT> const& h)
{
...
// line - aabb
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, aabb_boundary<D, ScalarT> const& b)
{
...
// line - box
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, box_boundary<D, ScalarT> const& b)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, box<2, ScalarT, 3> const& b)
{
...
// line - disk
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, sphere<2, ScalarT, 3> const& d)
{
...
// line - sphere
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, sphere_boundary<D, ScalarT> const& s)
{
...
// line - hemisphere
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, hemisphere_boundary<D, ScalarT> const& h)
{
    return detail::merge_hits(l, caps_of(h), boundary_no_caps_of(h));
}
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, hemisphere_boundary_no_caps<D, ScalarT> const& h)
{
    ScalarT hits[2] = {};
    auto numHits = 0;
...
// line - capsule
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, capsule_boundary<3, ScalarT> const& c)
{
...
// line - cylinder
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, cylinder_boundary<3, ScalarT> const& c)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, cylinder_boundary_no_caps<3, ScalarT> const& c)
{
...
// line - inf_cylinder
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, inf_cylinder_boundary<3, ScalarT> const& c)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line2(line<2, ScalarT> const& l, inf_cylinder_boundary<2, ScalarT> const& c)
{
...
// line - inf_cone
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line2(line<2, ScalarT> const& l, inf_cone_boundary<2, ScalarT> const& c)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, inf_cone_boundary<3, ScalarT> const& ic)
{
...
// line - cone
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, cone_boundary_no_caps<3, ScalarT> const& cone)
{
...
[[nodiscard]] constexpr hits<2, typename BaseT::scalar_t> intersection_parameter_line3(line<3, typename BaseT::scalar_t> const& l,                                                                                 pyramid_boundary_no_caps<BaseT> const& py)
...
[[nodiscard]] constexpr hits<2, typename BaseT::scalar_t> intersection_parameter_line3(line<3, typename BaseT::scalar_t> const& l, pyramid_boundary<BaseT> const& py)
{
...
// line - triangle2
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<hit_interval<ScalarT>> intersection_parameter_line2(line<2, ScalarT> const& l, triangle<2, ScalarT> const& t)
{
...
// line - triangle3
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l,                                                                triangle<3, ScalarT> const& t,                                                                dont_deduce<ScalarT> eps = 100 * tg::epsilon<ScalarT>)n                                                                triangle<3, ScalarT> const& t,
...
// line - ellipse
template <class ScalarT>
[[nodiscard]] constexpr hits<1, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, ellipse<2, ScalarT, 3> const& e)
{
...
template <int D, class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line(line<D, ScalarT> const& l, ellipse_boundary<D, ScalarT> const& e)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, ScalarT> intersection_parameter_line3(line<3, ScalarT> const& l, quadric<3, ScalarT> const& q)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<sphere_boundary<2, ScalarT, 3>> intersection_sphere_boundary3(sphere_boundary<3, ScalarT> const& a, sphere_boundary<3, ScalarT> const& b)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<pair<pos<2, ScalarT>, pos<2, ScalarT>>> intersection_sphere_boundary2(sphere_boundary<2, ScalarT> const& a,                                                                                          sphere_boundary<2, ScalarT> const& b)
...
// for now does not work if spheres are identical (result would be a sphere3 again)
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<sphere_boundary<2, ScalarT, 3>> intersection_sphere_boundary3(sphere_boundary<3, ScalarT> const& a, plane<3, ScalarT> const& b)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<sphere_boundary<2, ScalarT, 3>> intersection_plane3(plane<3, ScalarT> const& a, sphere_boundary<3, ScalarT> const& b)
{
...
// circle - plane
template <class ScalarT>
[[nodiscard]] constexpr hits<2, pos<3, ScalarT>> intersection_sphere2(sphere<2, ScalarT, 3, boundary_tag> const& a, plane<3, ScalarT> const& b)
{
    auto const l = intersection(plane_of(a), b);
    return intersection(l, sphere_boundary<3, ScalarT>(a.center, a.radius));
}
template <class ScalarT>
[[nodiscard]] constexpr hits<2, pos<3, ScalarT>> intersection_plane3(plane<3, ScalarT> const& a, sphere<2, ScalarT, 3, boundary_tag> const& b)
{
    return intersection(b, a);
}
...
// circle - sphere
template <class ScalarT>
[[nodiscard]] constexpr hits<2, pos<3, ScalarT>> intersection_sphere2(sphere<2, ScalarT, 3, boundary_tag> const& a, sphere_boundary<3, ScalarT> const& s)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, pos<3, ScalarT>> intersection_sphere_boundary3(sphere_boundary<3, ScalarT> const& a, sphere<2, ScalarT, 3, boundary_tag> const& b)
{
    return intersection(b, a);
}
...
// plane - plane
template <class ScalarT>
[[nodiscard]] constexpr line<3, ScalarT> intersection_plane3(plane<3, ScalarT> const& a, plane<3, ScalarT> const& b)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<pair<ScalarT, ScalarT>> intersection_parameters_segment2(segment<2, ScalarT> const& seg_0, segment<2, ScalarT> const& seg_1)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<ScalarT> intersection_parameter_segment2(segment<2, ScalarT> const& seg_0, segment<2, ScalarT> const& seg_1)
{
...
template <class ScalarT>
[[nodiscard]] constexpr pair<ScalarT, ScalarT> intersection_parameters_line2(line<2, ScalarT> const& l0, line<2, ScalarT> const& l1)
{
    auto M = mat<2, 2, ScalarT>::from_cols(l0.dir, -l1.dir);
    auto t = inverse(M) * (l1.pos - l0.pos);
    return {t.x, t.y};
...
template <int D, class ScalarT>
[[nodiscard]] constexpr cc::optional<aabb<D, ScalarT>> intersection_aabb(aabb<D, ScalarT> const& a, aabb<D, ScalarT> const& b)
{
    for (auto i = 0; i < D; ++i)
    {
        if (a.max[i] < b.min[i])
...
template <class ScalarT>
[[nodiscard]] constexpr pos<3, ScalarT> intersection_plane3(plane<3, ScalarT> const& a, plane<3, ScalarT> const& b, plane<3, ScalarT> const& c)
{
    return intersection(intersection(a, b), c).first();
}

template <int D, class ScalarT>
[[nodiscard]] constexpr cc::optional<ScalarT> intersection_parameter_segment(segment<D, ScalarT> const& a, plane<D, ScalarT> const& p)
{
...
template <int D, class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<D, ScalarT>> intersection_segment(segment<D, ScalarT> const& a, sphere<D, ScalarT> const& b)
{
...
template <int D, class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<D, ScalarT>> intersection_sphere(sphere<D, ScalarT> const& b, segment<D, ScalarT> const& a)
{
    return intersection(b, a);
}
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, tg::pos<3, ScalarT>> intersection_sphere_boundary3(sphere_boundary<3, ScalarT> const& sphere_boundary, segment<3, ScalarT> const& segment)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, tg::pos<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& segment, sphere_boundary<3, ScalarT> const& sphere_boundary)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_plane3(plane<3, ScalarT> const& plane, triangle<3, ScalarT> const& t)
{
    // classify vertices
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_triangle3(triangle<3, ScalarT> const& t, plane<3, ScalarT> const& plane)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_triangle3(triangle<3, ScalarT> const& t1, triangle<3, ScalarT> const& t2)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<pos<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& seg, triangle<3, ScalarT> const& t)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<pos<3, ScalarT>> intersection_triangle3(triangle<3, ScalarT> const& t, segment<3, ScalarT> const& seg)
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, aabb<3, ScalarT> const& bb) // NOT CONFIRMED
{
...
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_aabb3(aabb<3, ScalarT> const& bb, segment<3, ScalarT> const& s)
{
    return intersection(s, bb);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, box<3, ScalarT> const& bx)
{
...
// segment3 - capsule3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, capsule<3, ScalarT> const& c)
{
    return detail::intersection_segment_object_impl(s, c);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_capsule3(capsule<3, ScalarT> const& c, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, c);
}
...
// segment3 - cylinder3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, cylinder<3, ScalarT> const& c)
{
    return detail::intersection_segment_object_impl(s, c);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_cylinder3(cylinder<3, ScalarT> const& c, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, c);
}
...
// segment3 - ellipse3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, ellipse<3, ScalarT> const& e)
{
    return detail::intersection_segment_object_impl(s, e);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_ellipse3(ellipse<3, ScalarT> const& e, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, e);
}
...
// segment3 - sphere3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, sphere<3, ScalarT> const& e)
{
    return detail::intersection_segment_object_impl(s, e);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_sphere3(sphere<3, ScalarT> const& e, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, e);
}
...
// segment3 - tube3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, tube<3, ScalarT> const& t)
{
    return detail::intersection_segment_object_impl(s, t);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_tube3(tube<3, ScalarT> const& t, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, t);
}
...
// segment3 - cone3
template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, cone<3, ScalarT> const& c)
{
    return detail::intersection_segment_object_impl(s, c);
}

template <class ScalarT>
[[nodiscard]] constexpr cc::optional<segment<3, ScalarT>> intersection_cone3(cone<3, ScalarT> const& c, segment<3, ScalarT> const& s)
{
    return detail::intersection_segment_object_impl(s, c);
}
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, tg::pos<3, ScalarT>> intersection_segment3(segment<3, ScalarT> const& s, cylinder_boundary<3, ScalarT> const& c)
{
...
template <class ScalarT>
[[nodiscard]] constexpr hits<2, tg::pos<3, ScalarT>> intersection_cylinder_boundary3(cylinder_boundary<3, ScalarT> const& c, segment<3, ScalarT> const& s)
{
